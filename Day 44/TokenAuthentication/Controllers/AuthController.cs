...
namespace TokenAuthentication.Controllers
{
    ...
    public class AuthController: ControllerBase
    {
        ...
        public async Task<IActionResult> Login(LoginDto loginDto)
        {
            ...
            var claims = new[]
            {
                new Claim(ClaimTypes.NameIdentifier, userFromRepo.Userid.ToString()),//claim is an inbuild class .net 
            ...
            return Ok(new {token = tokenHandler.WriteToken(token), email = userFromRepo.Email, fullname = userFromRepo.Fullname});   //WriteToken write the token on the browser 
        }
    }
}